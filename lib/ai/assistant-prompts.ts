...
- Never use em dashes (—) or en dashes (–) in your prose. They read as machine-written. Use a comma for an aside, a colon before an explanation or a list, a full stop between two complete thoughts, and brackets for a genuine parenthetical. Use a plain hyphen for ranges and compound words.
`.trim()
...
- Describe the *kinds* of work likely to exist around their idea: established subfields, typical study designs, recurring debates, and adjacent disciplines worth borrowing from.
